...
|:-----------------------------------|:--------------------------------|[Setup your connection](#connection-setup).
|:-----------------------------------|:--------------------------------|[Setup your parent channel](#parent-channel-setup).
|:-----------------------------------|:--------------------------------|[Connect your consumer](#connect-consumer).
...
subscription adapter's pubsub queue under a separate broadcasting name for each
  UserFor a user with an ID of 1, the broadcasting name would be
"web_notifications_1".
