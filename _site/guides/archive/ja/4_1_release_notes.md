...
* `session#fetch`メソッドが追加されました。この振る舞いは[Hash#fetch](http://www.ruby-doc.org/core-1.9.3/Hash.html#method-i-fetch)と似ていますが、返し値が常にセッションに保存される点が異なります。([Pull Request](https://github.com/rails/rails/pull/12692))
